...
<h2>Utilisation</h2>
<p>La présente interface propose d'associer des pages web avec des configuration de tests.</p>
<dl>
  <dt>Page web&nbsp;:</dt>
  <dd>Une page est représentée par son url</dd>
  <dt>Configuration de test&nbsp;:</dt>
  <dd>Une configuration de test représente un ensemble de test qu'il convient de passer sur une page web. Elle identifiée par un libellé.</dd>
</dl>
...
<h2>Page web</h2>
<p>L'écran d'une page web permet d'associer une ou plusierus configuration de tests à la page web.</p>
