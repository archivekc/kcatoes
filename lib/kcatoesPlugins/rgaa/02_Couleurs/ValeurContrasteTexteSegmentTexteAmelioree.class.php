...
class ValeurContrasteTexteSegmentTexteAmelioree extends \ASource
{

  const testName = 'Valeur du rapport de contraste du texte contenu dans un segment de texte (améliorée)';
  const testId = '2.13';
