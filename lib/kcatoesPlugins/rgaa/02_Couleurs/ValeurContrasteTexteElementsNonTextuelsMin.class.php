...
class ValeurContrasteTexteElementsNonTextuelsMin extends \ASource
{
  ...
  protected static $testProc = array(
    ...
    ,'Si la couleur du texte et celle de son arrière plan ont été définies par la charte graphique du service de communication publique en ligne, et que cette
      définition est ultérieure à la publication du RGAA, poursuivre le test, sinon le test est non applicable.'
  ...
  public function execute()
  {
    ...
    if (count($nodes) == 0) {
      ...
      foreach($nodes as $node){
        ...
        contraste entre la couleur du texte et celle de son arrière plan est
