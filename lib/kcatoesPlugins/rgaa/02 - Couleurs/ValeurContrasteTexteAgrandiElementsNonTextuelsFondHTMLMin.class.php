...
class ValeurContrasteTexteAgrandiElementsNonTextuelsFondHTMLMin extends \ASource
{
  ...
  protected static $testProc = array(
    ...
    ,'Si la taille finale du texte affichée est supérieure ou égale à 150% ou 120% gras de la taille du texte par défaut spécifiée par les styles de la page, 
      ou, en son absence, de la taille fixée couramment par un navigateur, poursuivre le test, sinon le test est non applicable.'
    ,'Si la couleur du texte et celle de son arrière plan ont été définies par la charte graphique du service de communication publique en ligne, et que cette 
      définition est ultérieure à publication du RGAA, poursuivre le test, sinon le test est non applicable.'
    ,'Si le rapport de contraste entre la couleur du texte agrandi et celle de son arrière plan est supérieur ou égal à 3, le test est validé, sinon le test est invalidé.');
