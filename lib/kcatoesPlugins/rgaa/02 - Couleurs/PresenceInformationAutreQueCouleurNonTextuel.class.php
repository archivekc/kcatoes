...
class PresenceInformationAutreQueCouleurNonTextuel extends \ASource
{
  ...
  protected static $testProc = array(
    ...
    ,'Si l’élément affiche des zones de couleurs donnant de l’information, poursuivre le test, sinon le test est non applicable.'
    ,'Si l’information transmise par les zones de couleurs est accessible par un autre moyen que la couleur, le test est validé sinon le test est invalidé.');
