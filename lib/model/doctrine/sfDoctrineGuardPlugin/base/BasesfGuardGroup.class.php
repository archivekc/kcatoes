 ...
 * @property Doctrine_Collection $CollectionTests
 * 
 ...
 * @method Doctrine_Collection getCollectionTests()        Returns the current record's "CollectionTests" collection
 ...
 * @method sfGuardGroup        setCollectionTests()        Sets the current record's "CollectionTests" collection
 * 
 * @package    kcatoes
 * @subpackage model
...
abstract class BasesfGuardGroup extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('ProfilTest as CollectionTests', array(
             'local' => 'id',
             'foreign' => 'profil_id'));
